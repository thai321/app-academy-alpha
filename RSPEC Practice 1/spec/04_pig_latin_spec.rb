...
describe "#translate" do
  ...
  it "capitalize 1, translates a word beginning with a vowel" do
    s = translate("Apple")
    expect(s).to eq("Appleay")
  end

  it "capitalize 2 , counts 'qu' as a consonant even when it's preceded by a consonant" do
    s = translate("Square")
    expect(s).to eq("Aresquay")
  end

  it "capitalize 3, translates many words" do
    s = translate("the quick Brown Fox")
    expect(s).to eq("ethay ickquay Ownbray Oxfay")
  end
