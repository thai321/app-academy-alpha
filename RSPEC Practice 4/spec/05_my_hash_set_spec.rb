...
describe MyHashSet do
  ...
  describe "Bonus question, set symmetric_difference method" do
    before(:each) do
      set1.insert(1)
      set1.insert(7)
      set1.insert(3)
    ...
    describe "#symmetric_difference" do
      it "return a Hash SET" do
        expect(set1.symmetric_difference(set2)).to be_a(MyHashSet)
      end

      it "return elements contained in either `set1` or `set2`, but not both!" do
  ...
  describe "Bonus question, set ==(object) method" do
    describe "#==" do
      it "return true, set1 and set2 are empty" do
        expect(set1 == set2).to be_truthy
      end

      it "return false, set1 and set2 has 2 elements but different values" do
        set1.insert(1)
        set1.insert(2)
        set2.insert(1)
        set2.insert(5)
      ...
      it "return true, set1 and set2 has 3 sames elements" do
        set1.insert(1)
        set1.insert(2)
        set2.insert(1)
        set2.insert(5)
